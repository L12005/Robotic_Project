...
class BehaviorNode(Node):
    ...
    def _declare_and_load_config(self) -> ControllerConfig:
        return ControllerConfig(
            ...
            human_zone_time=self.declare_parameter('human_zone_time', 1.50).value,
            human_exit_time=self.declare_parameter('human_exit_time', 1.80).value,
            human_zone_half_width=self.declare_parameter('human_zone_half_width', 0.70).value,
